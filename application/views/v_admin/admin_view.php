						...
						<table class="table table-bordered table-striped" id="example2">
							...
							<tbody>
								...
								<tr>
									...
									<td align="center">
										<?php echo anchor('Admin/ubah/'.$data_record['fnip'],'<i class="fa fa-pencil"></i>',array('class'=>'btn btn-primary btn-flat'))?>
										<?php echo anchor('Admin/hapus/'.$data_record['fnip'],'<i class="fa fa-trash"></i>',array('class'=>'btn btn-warning btn-flat'))?>									
									</td>
								</tr>
								<?php } ?>
							</tbody>
